...
### HIGH-009: Grafana Data Loss (`emptyDir`) — FIXED
...
### HIGH-010: Prometheus Data Loss (Deployment vs StatefulSet) — FIXED
...
### HIGH-011: Python Import Errors — FIXED
...
### HIGH-012: Missing Python Dependencies in pyproject.toml — FIXED
...
| Priority | Issue | Estimated Effort | Assignee | Status |
|----------|-------|-----------------|----------|--------|
...
> **MEDIUM and LOW severity items** (Istio mTLS, Gatekeeper coverage, Helm charts, Terraform hardening, ML platform debt, monitoring config, CI/CD polish, product roadmap) are tracked in [`backlog.md`](backlog.md) — the canonical backlog for non-critical work.
